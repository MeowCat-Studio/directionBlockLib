...
["anvil_base", 0], ["anvil_base", 0]]]
    ...
    var i;
    for ( i = 0 ; i <= modelArray.length ; i += 1 ){
    model.addBox(1 - modelArray[i][0] , modelArray[i][1] ,1- modelArray[i][2] ,1- modelArray[i][3] , modelArray[i][4] ,1 - modelArray[i][5] , [modelArray[i][6][0],modelArray[i][6][1],modelArray[i][6][5],modelArray[i][6][4],modelArray[i][6][2], modelArray[i][6][3]]);
    }
    render.addEntry(model);
    BlockRenderer.setStaticICRender(id, -1 , render);
    },
    ...
    var i;
    for ( i = 0 ; i <= modelArray.length ; i += 1 ){
    model.addBox(1 - modelArray[i][2] , modelArray[i][1] ,1- modelArray[i][0] ,1- modelArray[i][5] , modelArray[i][4] ,1 - modelArray[i][3] , [modelArray[i][6][0],modelArray[i][6][1],modelArray[i][6][3],modelArray[i][6][2],modelArray[i][6][5], modelArray[i][6][4]]);
    }
    render.addEntry(model);
    BlockRenderer.setStaticICRender(id, -1 , render);
    },
   ...
   var render = new ICRender.Model();
    ...
    var i;
    for ( i = 0 ; i <= modelArray.length ; i += 1 ){
    model.addBox(modelArray[i][2] , modelArray[i][1] ,modelArray[i][0] ,modelArray[i][5] , modelArray[i][4] , modelArray[i][3] , [modelArray[i][6][0],modelArray[i][6][1],modelArray[i][6][4],modelArray[i][6][5],modelArray[i][6][3], modelArray[i][6][2]]);
    }
    render.addEntry(model);
    BlockRenderer.setStaticICRender(id, -1 , render);
    },
